...
const AdministrarEquipoForm = ({ equipo }: { equipo: EquipoConComponentes }) => {
    ...
    const [data, setData] = useState<EquipoConComponentes>(equipo);
      ...
      <Paper elevation={2} sx={{ padding: "16px", width: "calc(100%-16px)" }}>
        ...
        <Stack>
                ...
                <Grid container spacing={2} columns={{ xs: 6, lg: 12 }}>
                  ...
                  <Grid item xs={6} lg={6}>
                    <Button
                      ...
                      fullWidth
                      disabled={
                        data?.hardware.length === 0 && data?.software.length === 0
                      }
                    >
                      Finalizar
                    </Button>
          ...
          <Stack spacing={2}>
            <Divider />
            <EquipoHardwareTable
              data={data?.hardware.filter((hardware) => hardware.equipo !== null)}
...
export default AdministrarEquipoForm